...
public class ConsultaTableModel  extends AbstractTableModel {
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        case 1: 
        	consulta.setObservacao(aValue.toString()) ;break;
        case 2: 
        	
        case 3: 
        consulta.setTipoConsulta(TipoConsulta.CONVENCIONAL);break;
        case 4: 
        	consulta.getMedico().setNome(aValue.toString());break;
    ...
    public Object getValueAt(int linha, int coluna) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy hh:mm");
        switch(coluna) {
        case 0: valueObject = String.valueOf(consultaSelecionada.getId()) ;break;
        case 1: valueObject = sdf.format(consultaSelecionada.getDataMarcada()).toString() ;break;
        case 2: valueObject = consultaSelecionada.getObservacao();break;
        case 3: valueObject = String.valueOf(consultaSelecionada.getTipoConsulta().getCod());break;
        case 4: valueObject = consultaSelecionada.getMedico().getNome();break;
        default: System.err.println("Índice inválido");
        }
        return valueObject;
    }
