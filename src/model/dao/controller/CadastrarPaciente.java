	...
	private void initialize(Integer opt,Paciente  pa) throws ParseException {
		...
		btnCancelar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int escolha = JOptionPane.showConfirmDialog(null, "Gostaria de cancelar?", "Cancelar", JOptionPane.YES_NO_OPTION);
				if(escolha==0) {
		...
		btnSalvar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(tfNome.getText().equals("") || tfTelefone.getText().equals("") || tfEmail.getText().equals("") || tfCpf.getText().equals("")
							 || tfUsuario.getText().equals("") || tfSenha.getText().equals("") || tfSenha2.getText().equals("")
							|| tfLogra.getText().equals("") || tfNum.getText().equals("") || tfCep.getText().equals("") || tfCidade.getText().equals("")
							|| tfEstado.getText().equals("") || tfDtNasci.getText().equals("") ) {
